...
extension UIViewController {
	...
	func popToLastViewController(of viewControllerClass: AnyClass, animated: Bool = true) -> Bool {
	...
	func popToLastViewController(excluding classes: [AnyClass], animated: Bool = true) -> Bool {
